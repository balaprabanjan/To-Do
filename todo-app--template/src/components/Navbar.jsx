  ...
  return (
    <nav className="bg-black p-4 fixed w-full z-10 top-0 left-0">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <a href="http://127.0.0.1:5500/todo.html" className="bg-black text-white font-sans transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-orange-500 duration-300 rounded-xl px-2 py-2">Make Your List</a>
